# 1 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino"
# 1 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino"
...
# 8 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 9 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 10 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 11 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 12 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 13 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 14 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 15 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 16 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 17 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
# 18 "D:\\programming\\arduino\\watch2\\watch2\\watch2.ino" 2
...
// object creation
SPIClass *vspi = new SPIClass(3 /*SPI bus normally attached to pins 5, 18, 19 and 23, but can be matrixed to any pins*/); // VSPI object
Adafruit_SSD1351 oled = Adafruit_SSD1351(128, 96, vspi, 5/*17  // goes to TFT CS*/, 22/*16  // goes to TFT DC*/, 21/*5   // ESP RST to TFT RESET*/); //hw spi (use vspi or &SPI)
//Adafruit_SSD1351 oled = Adafruit_SSD1351(128, 96, _cs, _dc, _mosi, _sclk, _rst);  //sw spi
Preferences preferences;

//button objects
Button btn_dpad_up(33, 25, false, false);
Button btn_dpad_down(27, 25, false, false);
Button btn_dpad_left(32, 25, false, false);
Button btn_dpad_right(25, 25, false, false);
Button btn_dpad_enter(26, 25, false, false);
...
void drawTopThing()
{
    ...
    if ( millis() - last_battery_reading > 1000)
    {
        ...
        batteryVoltage = ReadVoltage(34) * 2 /*scale factor of voltage divider*/;
        batteryPercentage = ( batteryVoltage / 3.3 /*max voltage of battery (when fully charged)*/ ) * 100.0;
        last_battery_reading = millis();

        oled.fillRect(0, 0, 128, 10, 0x0000); //update this to only clear status portion
...
void switchState(int newState, int variant, int dim_pause_thing, int bright_pause_thing)
{
    ...
    oled.fillScreen(0x0000); //clear screen
