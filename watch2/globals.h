...
extern SdFat SD;                                                                           //sdfat instance used for accessing sd card
...
extern String file_path;                                                                   //if the file select menu is active, this is used to keep track of the current directory.
